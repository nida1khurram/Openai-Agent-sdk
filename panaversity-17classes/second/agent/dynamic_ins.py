...
#test 4 
#class, dataclass, pydantic, typeclass
...
#test 1 app change nhi kr sakte
def dynamic_instructions(agent,wrapper)->str:
#same test 1
# def dynamic_instructions(agent:Agent,wrapper:[RunContextWrapper])->str:
    print("Use dynamic func")
    print(f"Context:{wrapper}")
    print(f"agent:{agent}")
    return "You are a helpful assistant"

# #test 3 async
# async def dynamic_instructions(wrapper:[RunContextWrapper],agent:Agent)->str:
#     print("Use dynamic func")
#     print(f"Context:{wrapper}")
#     print(f"agent:{agent}")
#     return "You are a helpful assistant"

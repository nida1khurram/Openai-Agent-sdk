...
def add(n1:int, n2:int) -> str:
    ...
    # return f"The answer is : {n1+n2}"#"run_llm_again" #llm tool answer modify 2 + 2 = 4
    return f"The answer is : {n1+n2}"# tool_use_behavior="stop_on_first_tool" The answer is : 4
@function_tool
